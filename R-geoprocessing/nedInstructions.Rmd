...
tiles <- read_sf("M:/geodata/elevation/ned/ned_1arcsec_g.shp", layer = "ned_1arcsec_g")
...
# Region 11
tiles5 <- read_sf("M:/geodata/elevation/ned/tiles5_overlapping.shp", layer = "tiles5_overlapping")
...
lapply(., function(x) {
  crop("M:/geodata/land_use_land_cover/nlcd_2011_landcover_2011_edition_2014_03_31.img",
       paste0("M:/geodata/project_data/11REGION/nlcd30m_11R_lulc_", x$idx, ".tif"),
       x,
       "+init=epsg:5070"
       )})
...
lulc <- list.files(
  "M:/geodata/project_data/11REGION",
  recursive = TRUE,
...
# crop
split(tiles[2:nrow(tiles), ], tiles$idx[2:nrow(tiles)]) ->.;
lapply(., function(x) {
  crop("C:/geodata/elevation/ned/ned_10m_r11.tif",
       paste0("M:/geodata/elevation/ned/ned_10m_r11_", x$idx, ".tif"),
       x,
       "+init=epsg:5070"
       )})
...
split(tiles, tiles$idx) ->.;
lapply(., function(x) {
  resample(paste0("C:/geodata/elevation/ned/ned_10m_r11_", x$idx, ".tif"), 
           paste0("C:/geodata/elevation/ned/ned_30m_r11_", x$idx, ".tif"), 
           30
           )
  })

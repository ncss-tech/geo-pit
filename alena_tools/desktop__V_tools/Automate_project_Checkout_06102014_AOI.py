...
AOI = arcpy.GetParameterAsText (6)#Input project booundary, Feature Layer or Raster Cataglo Layer or Mosaic Layer, Required
...
arcpy.SelectLayerByLocation_management (inFC, "WITHIN_A_DISTANCE", AOI, indist,"ADD_TO_SELECTION" )

#Select Layer By Location ~Input SF Points, ADD_TO_SELECTION, 250 METERS, WITHIN_A_DISTANCE
arcpy.SelectLayerByLocation_management (insfpt, "WITHIN_A_DISTANCE", AOI, indist,"ADD_TO_SELECTION")

#Select Layer By Location ~ Input SF Lines, ADD_TO_SELECTION, 250 METERS, WITHIN_A_DISTANCE
arcpy.SelectLayerByLocation_management (insfln, "WITHIN_A_DISTANCE", AOI, indist,"ADD_TO_SELECTION")
...
arcpy.FeatureClassToFeatureClass_conversion(projectAOI, fdname, prjname+"b")
#Create Topology
